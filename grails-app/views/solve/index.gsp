...
<body>
    <div class="container row">
        ...
        <div class="col-1"><g:link action="index" params="[level: level]"><span class="badge badge-pill badge-warning">Random</span></g:link></div>

    </div>
    <div class="container">
        <g:form action="submitAnswer" method="post">
            <div class="form-group">
                <g:hiddenField name="problemId" id="problemId" value="${problem.id}"/>
                <g:hiddenField name="level" id="level" value="${level}"/>
